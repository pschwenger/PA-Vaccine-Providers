from config import GOOGLE_SHEET_ID_PRIMARY, GOOGLE_SHEET_ID_MAP, PROVIDER_SHEET_NAME
...
OUTPUT_SHEET = GOOGLE_SHEET_ID_MAP

# replace these with the columns you'd like to generate instead
COLUMNS = ["Clinic Name", "Street Address", "City", "State", "ZIP Code", "X", "Y", "Last Updated", "Clinic Website", "Prescreen or Appointment Web Address", "Clinic Phone", "Vaccine Appointments Available", "Walk-ins Accepted", "Sunday Hours", "Monday Hours", "Tuesday Hours", "Wednesday Hours", "Thursday Hours", "Friday Hours", "Saturday Hours"]
